          ...
          <div class="card p-3">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <button type="button" id="btnNew" class="btn bg-gradient-info mb-0" data-bs-toggle="modal" data-bs-target="#ModalPangkat">
            ...
            <div class="card-body">
              <div class="table-responsive text-sm">
                <table id="tablePangkat" class="table align-items-center">
                  <thead>
                    <tr>
...
<?php 
    include "./includes/modal/pangkat.php";
    include "./includes/footer.php"
?>

<script type="text/javascript" src="javascript/pangkat.js?v=<?= date('YmdHis') ?>"></script>
