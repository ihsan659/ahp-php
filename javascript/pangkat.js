varId.url = '/ajax/pangkat.php';
varId.Nama = document.getElementById('Nama');
varId.Description = document.getElementById('Description');

varId.table = document.getElementById('tablePangkat');
varId.modal = document.getElementById('ModalPangkat');
varId.dataTable = $('#tablePangkat');
var data = {
    id: '',
    description : '',
    nama : '',
...
function getData(method, _data){
    ...
    refresh(_data, varId.table, varId.dataTable, 'pangkat', varId.url);
}
